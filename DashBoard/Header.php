            ...
            <div class="modal-body "  style="padding-left: 20px ">
                ...
                <div style="padding-left: 20px">
                    <div class='row col-sm-12 form-group ' >
                        Username:<br><br><input type="email"  placeholder="abc@gmail.com" class="text-center  form-control" required="">
                    </div>
                    <div class='row col-sm-12 form-group'>
                        Password:<br><br><input type="password" placeholder="password" class="text-center form-control" required="">
                    </div>
                    <div class='row col-sm-12 form-group'>
                ...
                <div class="row">
                    <div class=' col-md-6 form-group'>
                        <button type="button" class="btn btn-outline-success btn-block" onclick="showAlert();">Login</button>
                    </div>
                    <div class=' col-md-6 form-group'>
...
<div class="container-fluid" style="background-color: lightyellow;">
    <div class="row">
        <div class="col-md-6 col-sm-12" >
            <img src="../images/KASHMIRI.jpg" alt="Image not found.."  style="height:80px"class="img-responsive"/>
        </div>
        <div class="col-md-6 row col-sm-12" >
            <div class="offset-md-5 col-md-7  col-sm-12  form-group"style="padding-top: 20px">
                <div class="input-group input-group-sm" style="padding-top: 0.6rem">              
                    <input type="text" placeholder="search  by Name,Id,Category.." class="form-control">
